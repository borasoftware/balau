...
#include "FileByteWriteResourceTest.hpp"
...
File FileByteWriteResourceTest::prepWritePath(const std::string & testName, const std::string & text) {
...
void FileByteWriteResourceTest::test() {
