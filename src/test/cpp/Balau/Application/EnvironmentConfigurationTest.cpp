...
struct EnvironmentConfigurationTest : public Testing::TestGroup<EnvironmentConfigurationTest> {
	EnvironmentConfigurationTest() {
		RegisterTest(derivedEmpty);
		RegisterTest(derivedSimple);
		RegisterTest(derivedComposite);

		RegisterTest(directEmpty);
		RegisterTest(directSimple);
		RegisterTest(directComposite);
		RegisterTest(directMultiple);

		RegisterTest(mixedEmpty);
		RegisterTest(mixedSimple);
		RegisterTest(mixedComposite);
		RegisterTest(mixedMultiple);

		RegisterTest(derivedSimpleWithDefaults);
		RegisterTest(derivedCompositeWithDefaults);

		RegisterTest(directSimpleWithDefaults);
		RegisterTest(directCompositeWithDefaults);
		RegisterTest(directMultipleWithDefaults);

		RegisterTest(mixedSimpleWithDefaults);
		RegisterTest(mixedCompositeWithDefaults);
		RegisterTest(mixedMultipleWithDefaults);

		RegisterTest(includedFilesConfig);

		RegisterTest(balauConfig);
	}
