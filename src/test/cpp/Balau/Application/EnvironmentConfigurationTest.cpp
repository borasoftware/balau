...
struct EnvironmentConfigurationTest : public Testing::TestGroup<EnvironmentConfigurationTest> {
	EnvironmentConfigurationTest() {
		RegisterTestCase(derivedEmpty);
		RegisterTestCase(derivedSimple);
		RegisterTestCase(derivedComposite);

		RegisterTestCase(directEmpty);
		RegisterTestCase(directSimple);
		RegisterTestCase(directComposite);
		RegisterTestCase(directMultiple);

		RegisterTestCase(mixedEmpty);
		RegisterTestCase(mixedSimple);
		RegisterTestCase(mixedComposite);
		RegisterTestCase(mixedMultiple);

		RegisterTestCase(derivedSimpleWithDefaults);
		RegisterTestCase(derivedCompositeWithDefaults);

		RegisterTestCase(directSimpleWithDefaults);
		RegisterTestCase(directCompositeWithDefaults);
		RegisterTestCase(directMultipleWithDefaults);

		RegisterTestCase(mixedSimpleWithDefaults);
		RegisterTestCase(mixedCompositeWithDefaults);
		RegisterTestCase(mixedMultipleWithDefaults);

		RegisterTestCase(includedFilesConfig);

		RegisterTestCase(balauConfig);
	}
