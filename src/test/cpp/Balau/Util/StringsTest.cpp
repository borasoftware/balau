...
struct StringsTest : public Testing::TestGroup<StringsTest> {
	StringsTest() {
		RegisterTest(toUpper_string);
		RegisterTest(toUpper_u32string);
		RegisterTest(toLower_string);
		RegisterTest(toLower_u32string);
		RegisterTest(equalsIgnoreCase_string_string);
		RegisterTest(equalsIgnoreCase_u32string_u32string);
		RegisterTest(startsWith_string_string);
		RegisterTest(startsWith_string_char);
		RegisterTest(startsWith_u32string_u32string);
		RegisterTest(startsWith_u32string_char32_t);
		RegisterTest(endsWith_string_string);
		RegisterTest(endsWith_string_char);
		RegisterTest(endsWith_u32string_u32string);
		RegisterTest(endsWith_u32string_char32_t);
		RegisterTest(contains_string_string);
		RegisterTest(contains_string_char);
		RegisterTest(contains_u16string_u16string);
		RegisterTest(contains_u16string_char16_t);
		RegisterTest(contains_u32string_u32string);
		RegisterTest(contains_u32string_char32_t);
		RegisterTest(occurrences_string_string);
		RegisterTest(occurrences_u32string_u32string);
		RegisterTest(occurrences_string_regex);
		RegisterTest(lineLengths);
		RegisterTest(lastIndexOf_string_string);
		RegisterTest(lastIndexOf_u32string_u32string);
		RegisterTest(codePointCount_string);
		RegisterTest(codePointCount_u32string);
		RegisterTest(append_string_char);
		RegisterTest(append_string_char32_t);
		RegisterTest(append_u32string_char32_t);
		RegisterTest(padLeft_string_char);
		RegisterTest(padLeft_string_char32_t);
		RegisterTest(padLeft_u32string_char32_t);
		RegisterTest(padRight_string_char);
		RegisterTest(padRight_string_char32_t);
		RegisterTest(padRight_u32string_char32_t);
		RegisterTest(trim_string);
		RegisterTest(trim_u32string);
		RegisterTest(trimLeft_string);
		RegisterTest(trimLeft_u32string);
		RegisterTest(trimRight_string);
		RegisterTest(trimRight_u32string);
		RegisterTest(replaceAll_string_string);
		RegisterTest(replaceAll_u32string_u32string);
		RegisterTest(join_string);
		RegisterTest(join_u32string);
		RegisterTest(split_string_string);
		RegisterTest(split_u32string_u32string);
		RegisterTest(split_string_regex);
		RegisterTest(replaceAll_string_regex);
	}
