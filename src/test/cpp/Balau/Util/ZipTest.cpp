...
struct CompressionTest : public Testing::TestGroup<CompressionTest> {
	CompressionTest() {
		RegisterTestCase(fingerprintTest);
		RegisterTestCase(unzipperTest);
		RegisterTestCase(encryptedUnzipperTest);
		RegisterTestCase(zipperTest);
		RegisterTestCase(encryptedZipperTest);
		RegisterTestCase(libzipSoakTest);
		RegisterTestCase(libzipSoakTest2);
		RegisterTestCase(libzipSoakTest3);
	}
