...
#ifndef COM_BORA_SOFTWARE_BALAU_INTERPROCESS_IMPL_SHARED_MEMORY_QUEUE_IMPL
#define COM_BORA_SOFTWARE_BALAU_INTERPROCESS_IMPL_SHARED_MEMORY_QUEUE_IMPL
...
class SharedMemoryQueueTLS {
	...
	static SharedMemoryQueueTLS & storage() {
		thread_local SharedMemoryQueueTLS instance;
		return instance;
	}
};
...
#endif // COM_BORA_SOFTWARE_BALAU_INTERPROCESS_IMPL_SHARED_MEMORY_QUEUE_IMPL
