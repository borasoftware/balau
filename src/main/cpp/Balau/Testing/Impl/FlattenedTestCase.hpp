...
#ifndef COM_BORA_SOFTWARE_BALAU_TESTING_IMPL_FLATTENED_TEST_CASE
#define COM_BORA_SOFTWARE_BALAU_TESTING_IMPL_FLATTENED_TEST_CASE
...
#endif // COM_BORA_SOFTWARE_BALAU_TESTING_IMPL_FLATTENED_TEST_CASE
