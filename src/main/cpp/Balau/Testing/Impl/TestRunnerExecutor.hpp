...
#ifndef COM_BORA_SOFTWARE_BALAU_TESTING_IMPL_TEST_RUNNER_EXECUTOR
#define COM_BORA_SOFTWARE_BALAU_TESTING_IMPL_TEST_RUNNER_EXECUTOR
...
#endif // COM_BORA_SOFTWARE_BALAU_TESTING_IMPL_TEST_RUNNER_EXECUTOR
