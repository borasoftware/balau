...
///
/// @file HexUnsignedCharRenderer.hpp
///
/// Overload for rendering unsigned char containers as hex values.
///

#ifndef COM_BORA_SOFTWARE__BALAU_TESTING_TEST_RENDERERS__HEX_UNSIGNED_CHAR_RENDERER
#define COM_BORA_SOFTWARE__BALAU_TESTING_TEST_RENDERERS__HEX_UNSIGNED_CHAR_RENDERER
...
#endif // COM_BORA_SOFTWARE__BALAU_TESTING_TEST_RENDERERS__HEX_UNSIGNED_CHAR_RENDERER
