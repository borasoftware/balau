...
///
/// @file HexSignedLongLongRenderer.hpp
///
/// Overload for rendering signed long long containers as hex values.
///

#ifndef COM_BORA_SOFTWARE__BALAU_TESTING_TEST_RENDERERS__HEX_SIGNED_LONG_LONG_RENDERER
#define COM_BORA_SOFTWARE__BALAU_TESTING_TEST_RENDERERS__HEX_SIGNED_LONG_LONG_RENDERER
...
#endif // COM_BORA_SOFTWARE__BALAU_TESTING_TEST_RENDERERS__HEX_SIGNED_LONG_LONG_RENDERER
