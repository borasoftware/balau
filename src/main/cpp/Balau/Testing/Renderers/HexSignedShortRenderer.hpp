...
///
/// @file HexSignedShortRenderer.hpp
///
/// Overload for rendering signed short containers as hex values.
///

#ifndef COM_BORA_SOFTWARE__BALAU_TESTING_TEST_RENDERERS__HEX_SIGNED_SHORT_RENDERER
#define COM_BORA_SOFTWARE__BALAU_TESTING_TEST_RENDERERS__HEX_SIGNED_SHORT_RENDERER
...
#endif // COM_BORA_SOFTWARE__BALAU_TESTING_TEST_RENDERERS__HEX_SIGNED_SHORT_RENDERER
