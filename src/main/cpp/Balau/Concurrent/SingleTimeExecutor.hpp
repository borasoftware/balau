...
#ifndef COM_BORA_SOFTWARE__BALAU_CONCURRENT__SINGLE_TIME_EXECUTOR
#define COM_BORA_SOFTWARE__BALAU_CONCURRENT__SINGLE_TIME_EXECUTOR
...
#endif // COM_BORA_SOFTWARE__BALAU_CONCURRENT__SINGLE_TIME_EXECUTOR
