...
#ifndef BALAU_TP_HASH_LIBRARY_SHA256
#define BALAU_TP_HASH_LIBRARY_SHA256
...
class SHA256 //: public Hash
{
	...
	private: static uint32_t f1(uint32_t e, uint32_t f, uint32_t g) {
		uint32_t term1 = rotate(e, 6) ^rotate(e, 11) ^rotate(e, 25);
		uint32_t term2 = (e & f) ^(~e & g); //(g ^ (e & (f ^ g)))
		return term1 + term2;
	}

	private: static uint32_t f2(uint32_t a, uint32_t b, uint32_t c) {
...
#endif // BALAU_TP_HASH_LIBRARY_SHA256
