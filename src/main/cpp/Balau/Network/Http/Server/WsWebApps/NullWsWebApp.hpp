...
#ifndef COM_BORA_SOFTWARE_BALAU_NETWORK_HTTP_SERVER_WS_WEB_APPS_NULL_WS_WEB_APP
#define COM_BORA_SOFTWARE_BALAU_NETWORK_HTTP_SERVER_WS_WEB_APPS_NULL_WS_WEB_APP
...
#endif // COM_BORA_SOFTWARE_BALAU_NETWORK_HTTP_SERVER_WS_WEB_APPS_NULL_WS_WEB_APP
