...
#ifndef COM_BORA_SOFTWARE_BALAU_NETWORK_SERVER_WS_WEB_APPLICATION
#define COM_BORA_SOFTWARE_BALAU_NETWORK_SERVER_WS_WEB_APPLICATION
...
#endif // COM_BORA_SOFTWARE_BALAU_NETWORK_SERVER_WS_WEB_APPLICATION
