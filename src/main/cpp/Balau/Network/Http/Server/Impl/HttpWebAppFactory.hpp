...
#ifndef COM_BORA_SOFTWARE_BALAU_NETWORK_HTTP_SERVER_IMPL_HTTP_WEB_APP_FACTORY
#define COM_BORA_SOFTWARE_BALAU_NETWORK_HTTP_SERVER_IMPL_HTTP_WEB_APP_FACTORY
...
#endif // COM_BORA_SOFTWARE_BALAU_NETWORK_HTTP_SERVER_IMPL_HTTP_WEB_APP_FACTORY
