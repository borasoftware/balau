...
#ifndef COM_BORA_SOFTWARE_BALAU_NETWORK_UTILITIES_MIME_TYPES
#define COM_BORA_SOFTWARE_BALAU_NETWORK_UTILITIES_MIME_TYPES
...
#endif // COM_BORA_SOFTWARE_BALAU_NETWORK_UTILITIES_MIME_TYPES
