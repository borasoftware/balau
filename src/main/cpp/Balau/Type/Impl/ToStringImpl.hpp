...
//
#ifndef COM_BORA_SOFTWARE__BALAU_TYPE_IMPL__TO_STRING_IMPL
#define COM_BORA_SOFTWARE__BALAU_TYPE_IMPL__TO_STRING_IMPL
...
#endif // COM_BORA_SOFTWARE__BALAU_TYPE_IMPL__TO_STRING_IMPL
