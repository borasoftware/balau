...
///
/// UTF-8 specialisation of ToString<T>.
///
...
///
/// UTF-16 specialisation of ToString<T>.
///
/// Convert the supplied object to a std::u16string by calling toString16.
///
template <> struct ToString<char16_t> {
...
///
/// UTF-32 specialisation of ToString<T>.
///
/// Convert the supplied object to a std::u32string by calling toString32.
///
template <> struct ToString<char32_t> {
