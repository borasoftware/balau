...
#ifndef COM_BORA_SOFTWARE_BALAU_LOGGING_IMPL_LOGGER_ALLOCATOR
#define COM_BORA_SOFTWARE_BALAU_LOGGING_IMPL_LOGGER_ALLOCATOR
...
#endif // COM_BORA_SOFTWARE_BALAU_LOGGING_IMPL_LOGGER_ALLOCATOR
