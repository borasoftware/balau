...
#ifndef COM_BORA_SOFTWARE_BALAU_RESOURCE_URI_DISPATCHER
#define COM_BORA_SOFTWARE_BALAU_RESOURCE_URI_DISPATCHER
...
#endif // COM_BORA_SOFTWARE_BALAU_RESOURCE_URI_DISPATCHER
