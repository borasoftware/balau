...
#ifndef COM_BORA_SOFTWARE_BALAU_APPLICATION_INJECTABLE_HEADER
#define COM_BORA_SOFTWARE_BALAU_APPLICATION_INJECTABLE_HEADER
...
#endif // COM_BORA_SOFTWARE_BALAU_APPLICATION_INJECTABLE_HEADER
