...
///
#define InjectHeader(...) BalauVaArgsExpand(BalauVaArgsExpand(BalauInjectHeader)(__VA_ARGS__))
...
///
#define InjectHeaderConstruct(...) BalauVaArgsExpand(BalauVaArgsExpand(BalauInjectHeaderConstruct)(__VA_ARGS__))
