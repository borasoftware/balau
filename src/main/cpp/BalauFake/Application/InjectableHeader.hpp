...
#ifndef COM_BORA_SOFTWARE__BALAU_FAKE_APPLICATION__INJECTABLE_HEADER
#define COM_BORA_SOFTWARE__BALAU_FAKE_APPLICATION__INJECTABLE_HEADER
...
#endif // COM_BORA_SOFTWARE__BALAU_FAKE_APPLICATION__INJECTABLE_HEADER
